...
const Header = () => {
  ...
  return (
    <div>
      ...
      <nav className="flex items-center justify-between bg-gray-800 py-2 ">
        <Sidebar />
        <div className="hidden lg:block">
          <div className="flex items-center flex-shrink-0 text-white mr-6">
            <img src={logo} alt="logo" className="w-28 sm:hidden" />
          </div>
          <div className="w-full block flex-grow sm:hidden lg:flex xl:flex xl:justify-between lg:items-center ">
        ...
        {/* <div className="block lg:hidden xl:hidden flex">
