          ...
          <div className="w-full md:flex justify-between items-center block">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              <p className="break-words">
                ...
                высокоэффективных систем отопления, вентиляции и
            ...
            <div className="flex flex-col text-start md:max-w-3xl">
              <div className="mr-4">
                ...
                <p className="break-words">
                  ...
                  автоматики, двухкомпессорные системы позволяющие одновременную
                  работу в режимах нагрева/охлаждения и ГВС.
                </p>
              </div>
            </div>
                  ...
                  <div className="mb-4 flex items-start">
                    ...
                    <div className="pl-4">
                      ...
                      <p className="text-sm">
                        ...
                        квалифицированные специалисты обеспечат высокое качество
                        монтажа и наладки электрооборудования
                      </p>
                    </div>
                  </div>
                  <div className="mb-4 flex items-start">
