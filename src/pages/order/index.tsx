...
const Order = () => {
  return (
    <div className="w-full flex flex-col items-center">
      <div className="container flex justify-center my-8 mx-2 lg:mx-12">
        <div className=" container ">
          ...
          <div className="w-full md:w-3/5">
            <div className="w-full flex flex-col text-start ">
              ...
              <p className="text-gray-600 text-base">
                Онлайн заказ можно оплатить с помощью банковской карты,
                выпущенной на территории России. Оформляя заказ на сайте, в
                пункте «Оплата» выберите «Банковская карта». После переадресации
                на страницу системы безопасных платежей, необходимо лишь
                подтвердить платеж.
              </p>
            </div>
          ...
          <div className="w-full flex flex-col text-start md:w-3/5">
            ...
            <ul className="list-disc ul">
              <li className="py-2 text-gray-600 text-base">
                обмен или возврат товара в срок до 14 дней с момента
                приобретения;
              </li>
              <li className="py-2 text-gray-600 text-base">
          ...
          <div className="w-full flex flex-col text-start md:w-3/5">
            ...
            <p className="text-gray-600 text-base">
              Уважаемый покупатель, приносим извинения за неудобства,
              случившиеся в связи с выходом из строя. По вашему обращению будут
              приняты все меры для быстрого решения вашей проблемы.
            </p>
          </div>
        </div>
      </div>
