      ...
      <div className=" container flex justify-center my-8">
        <div className="container w-full mx-2">
          <div className="mb-4">
            <h2>
              ...
              <span className="text-gray-400">
                Статьи/ Эффективность солнечного коллектора
              </span>
            </h2>
          </div>
          ...
          <div className="w-full words-break">
            ...
            <p className="pt-2">
              На практике же дело может обстоять немного иначе. Одним из
              факторов влияющим на производительность является объемный расход
              ...
              200 л/ч. При пересчета на 1 м² апертурной площади расход равен
              40,6 л/ч м². При этом есть существенная разница между этим
              значением и рекомендуемым значением производителя 25 л/ч м². В
              некоторых случаях, разница между этими показателями может
              отличатся в 3-4 раза.
            </p>
